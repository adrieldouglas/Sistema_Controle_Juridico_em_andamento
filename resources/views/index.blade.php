...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">        
        <h1 class="text-right display-2 font-weight-bold text-white" style="margin-top: 25%;">Controle Jurídico</h1>
        <h3 class="text-white text-right font-weight-bold">Company Adriel Douglas</h3>
        <a href="{{ route('admin.login') }}" class="btn btn-lg bg-primary float-right text-white"><i class="bi bi-box-arrow-right"></i> ACESSAR</a>
      </div>
    </div>
  </div>
