                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="name">Nome Completo<i
                                                        ...
                                                        placeholder="Digite o nome" style="border-color: orange;">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Digite o apelido" style="border-color: orange;">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Digite o endereço" style="border-color: orange;">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Digite o bairro" style="border-color: orange;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Digite o cidade" style="border-color: orange;">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Digite o complemento" style="border-color: orange;">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
...
<div class="col-sm-4">
    <div class="form-group">
        ...
        placeholder="Digite o site" style="border-color: orange;">
    </div>
</div>
</div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-sm-4">
        ...
        placeholder="Digite a empresa" style="border-color: orange;">
    </div>
    <div class="col-sm-5">
        <label for="profession">Profissão</label>
        <input type="text" name="profession" class="form-control"
        placeholder="Digite a profissão" style="border-color: orange;">
    </div>
</div>
<div class="row mt-3">
    <div class="col-sm-4">
...
<div class="col-sm-4">
    <div class="form-group">
        ...
        placeholder="Nome da mãe, nome do pai" style="border-color: orange;"></textarea>
    </div>
</div>
</div>
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            placeholder="Digite a cidade" style="border-color: orange;">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            placeholder="Digite a país" style="border-color: orange;">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            placeholder="Digite uma observação" style="border-color: orange;"></textarea>
        </div>
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            placeholder="Número / zona / sessão" style="border-color: orange;">
        </div>
    </div>
</div>
<div class="row">
